...
function _getDestTypeFromMethod(method) {
  ...
  if (['is_ready', 'get_reflected_host_info', 'is_chat_handle_in_use', 'record_btc_open_order',
      ...
      'get_users_pairs', 'get_sog_users_pairs', 'get_market_orders', 'get_market_trades', 'get_sog_cardforcard_markets_list', 'get_markets_list', 'get_sog_markets_list', 'get_market_details',
